...
export const Store = create<IState>((set) => ({
  ...
  setSelectedPost: (arg: Post) =>
    set((state) => ({ ...state, selectedPost: arg })),
  setIsPostsLoading: (arg) =>
    set((state) => ({ ...state, isPostsLoading: arg })),
  setShowSidebar: (arg) => set((state) => ({ ...state, showSidebar: arg })),
  setPostComments: (arg: Comment[]) =>
    set((state) => ({ ...state, postComments: arg })),
    setPostCommentsLoading: (arg) => set((state) => ({...state, postCommentsLoading: arg})),
  setPostCommentsError: (arg) => set((state) => ({...state, postCommentsError: arg})),
