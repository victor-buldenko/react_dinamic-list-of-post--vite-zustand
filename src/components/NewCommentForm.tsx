    ...
    <form 
      ...
      <div className="field" data-cy="NameField">
        ...
        <div className="control has-icons-left has-icons-right">
          ...
          <span
            className={cn('icon', 'is-small', 'is-right', {'has-text-danger': isNameEmpty})}
        ...
        {isNameEmpty && <p className="help is-danger" data-cy="ErrorMessage">
          Name is required
        </p>}
      </div>
      ...
      <div className="field" data-cy="EmailField">
        ...
        <div className="control has-icons-left has-icons-right">
          ...
          <span
            className={cn('icon', 'is-small', 'is-right', {'has-text-danger': isEmailEmpty})}
            data-cy="ErrorIcon"
          >
            <i className="fas fa-exclamation-triangle" />
          </span>
        ...
        {isEmailEmpty && <p className="help is-danger" data-cy="ErrorMessage">
          Email is required
        </p>}
      </div>
      ...
      <div className="field" data-cy="BodyField">
        ...
        {isCommentEmpty && <p className="help is-danger" data-cy="ErrorMessage">
          Enter some text
        </p>}
      </div>
